function getXDistance(p1, p2) {
    let diffX = Math.pow((p1.cameraX - p2.cameraX), 2);
    let distance = Math.pow((diffX), .5);
    return (distance);
}
...
export {
    getXDistance, getYDistance, getZDistance, getDistance, getMovementLevel, getAngle
};
