...
import SnatchAnalyzer from '../../components/analyzers/SnatchAnalyser';
    ...
    startConnection = (ipAddress) => {
        ...
        socket.on('bodyFrame', function (bodyFrame) {
            ...
            if (newBodyFrame[0] && newBodyFrame[0].cameraY && newBodyFrame[0].depthY) {
                ...
                this.refs.moveAnalyzer.addBodyFrame(newBodyFrame);
            } else {
                ...
                <Row type='flex' justify="center" style={{
                    ...
                    {this.state.connected ?
                        <div>
                            ...
                            <SnatchAnalyzer ref="moveAnalyzer" onProgress={(perc) => this.refs.jointAnimator.setProgress(perc)} />
